 ...
 * 这个代码是给大家的姿态解算的DEMO 基于imu963ra，如果是使用660ra仅需要把963数字全部换成660就行
 * 例如 gyroscope[0]= imu963ra_gyro_transition(imu963ra_gyro_x)* 0.0174533f; 只要把963数字改成660ra即可
 */
#include "Attitude.h"
...
void Attitude_Init()
{
    IMU_QuaternionEKF_Init(10, 0.001, 10000000, 0.9996, 0.001f,0); //ekf初始化
    //===========================================================================================
